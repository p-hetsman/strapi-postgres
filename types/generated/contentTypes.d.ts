...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    dishes: Attribute.Relation<'api::category.category', 'manyToMany', 'api::dish.dish'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiClientClient extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::client.client', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::client.client', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
...
export interface ApiDishDish extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categories: Attribute.Relation<'api::dish.dish', 'manyToMany', 'api::category.category'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::dish.dish', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::dish.dish', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    average_note: Attribute.Float;
    commentable: Attribute.Boolean;
    published: Attribute.Date;
...
export interface ApiRestaurantRestaurant extends Schema.CollectionType {
  ...
  attributes: {
    ...
    waiters: Attribute.Relation<'api::restaurant.restaurant', 'oneToMany', 'api::waiter.waiter'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiWaiterWaiter extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String & Attribute.Required & Attribute.Unique;
    restaurant: Attribute.Relation<'api::waiter.waiter', 'manyToOne', 'api::restaurant.restaurant'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::waiter.waiter', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::waiter.waiter', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
